...
<div class="content-browsing">
    ...
    <div class="content-sidebar">
        <div class="subtitle mb-20">Help request: {{ $helpRequest->decryptTitle() }} ({{ $helpRequest->status() }})
        </div>
        @staff
        <form action="{{ route('post.staff.closehelprequest', ['helpRequest' => $helpRequest->id]) }}" method="post"
            class="mb-20">
            @csrf
