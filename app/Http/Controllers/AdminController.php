...
class AdminController extends Controller
{
	...
	public function viewDashboard()
	{
		return view('staff.admin.dashboard', [
			...
			'redditForumLink' => config('general.reddit_forum_link'),
	...
	public function putDashboard(Request $request)
	{
		...
		#Edit footer links
		$this->editConfig('general.reddit_forum_link', $request->reddit_forum_link, 'general', 'general.php');
